...
Nach einer Einschätzung von der Abteilung für Datenverarbeitung wird zur Zeit in der Abteilung ein Mitarbeiter etwa 10 Stunden in der Woche
darauf verwendet, Symboliken miteinander zu vergleichen. Dies ergibt, mit dem in der Projektkostenkalkulation verwendeten
Stundenlöhnen und Kosten für Räumlichkeiten, Hard- und Software also 10*55€ = 550€ Pro Woche.
Der Autor verspricht sich im schlechtesten Fall durch das Programm eine Beschleunigung des Vergleichsprozesses von etwa 30\%. Im optimal Fall würde der Prozess nur noch etwa 2 Stunden (80\% Verbesserung) dauern. Als realistisch schätzt der
Autor eine Optimierung des Vorgangs um etwa 55\%\footnote{Die Zeiten wurden anhand von Kalkulationen der theorethischen Rechenvorgänge unter Einbezug von Schreib-, und Lesegeschwindigkeiten des Speichers, sowie Geschwindigkeit der CPU geschätzt.}.
